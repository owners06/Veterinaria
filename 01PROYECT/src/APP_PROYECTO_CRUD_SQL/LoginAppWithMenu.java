...
public class LoginAppWithMenu extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Inicio de Sesión - Proyecto Integrador USTA");
...
passwordField.setMaxWidth(maxWidth);        
        ...
        Image bannerImage = new Image("APP_EMPLEADOS_CRUD_SQL/banner.png");
        ...
        Label titleLabel = new Label("¡Bienvenido a la Aplicación de Gestión de Mascotas!");
...
// Establecer el tamaño de la escena
    ...
    private void openMenu() {
        ...
        Menu petsMenu = new Menu("Proyecto integrador veterinaria");
        MenuItem managePetsMenuItem = new MenuItem("Gestionar veterianaria");
        managePetsMenuItem.setOnAction(event -> openPetManager());
        petsMenu.getItems().add(managePetsMenuItem);

        menuBar.getMenus().addAll(fileMenu, petsMenu);
    ...
    private void openPetManager() {
        Veterinaria_APP_1 veterinaria_APP_1 = new Veterinaria_APP_1();
        veterinaria_APP_1.start(new Stage());
    }
